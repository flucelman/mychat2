...
const (
	...
	Greeter_UploadFile_FullMethodName = "/pb.Greeter/UploadFile"
)
...
func (c *greeterClient) UploadFile(ctx context.Context, in *UploadRequest, opts ...grpc.CallOption) (*UploadResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedGreeterServer) UploadFile(context.Context, *UploadRequest) (*UploadResponse, error) {
