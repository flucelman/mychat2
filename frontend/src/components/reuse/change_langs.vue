<template>
    <div class="selector-container">
        <div class="selector-item" @click="changeLang('zhCN')" :class="{ active: locale === 'zhCN' }">
            <div class="item-content">
                <span class="item-text">中文</span>
            </div>
        </div>
        <div class="selector-item" @click="changeLang('en')" :class="{ active: locale === 'en' }">
            <div class="item-content">
...
const changeLang = (newLang) => {
    globalSettingStore.lang = newLang
